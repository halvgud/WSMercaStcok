    ...
    public static function obtenerArticulo()
    {
        try {
            $post = json_decode(file_get_contents('php://input'),true);//ID_CATEGORIA
                $comando = "SELECT a.".self::ID_CATEGORIA.", a.".self::DESCRIPCION. ",a.".self::EXISTENCIA." AS NombreArticulo, U.".self::UNIDAD." AS Unidad  FROM " . self::TABLA_ARTICULO . " A INNER JOIN ".self::TABLA_INVENTARIO."
