 ...
 */
public class CategoriaAdapter extends ArrayAdapter<listaCategoria> {

    private Activity context;
    ArrayList<listaCategoria> data = null;

    public CategoriaAdapter(Activity context, int resource,
                           ArrayList<listaCategoria> data) {
    ...
    public View getDropDownView(int position, View convertView, ViewGroup parent) {
        ...
        listaCategoria item = data.get(position);
